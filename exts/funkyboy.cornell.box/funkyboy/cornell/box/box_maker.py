...
# omni.kit.commands.execute('ChangeProperty',
# 	prop_path=Sdf.Path('/World/Cornell_Box/RectLight.xformOp:scale'),
# 	value=Gf.Vec3d(6.000000089406967, 1.0, 1.0),
...
# omni.kit.commands.execute('ChangeProperty',
# 	prop_path=Sdf.Path('/World/Cornell_Box/RectLight.visibleInPrimaryRay'),
# 	value=True,
# 	prev=None)
